...
console.log ("Click the beholder to like this card!")
...
do {
    ...
    if (armorClass) {
        armorClass > 15
        console.log ("Este monstruo es demasiado poderoso para ganarle con solo una tirada")
    } else {
        console.log('¡Este monstruo puede ser vencido con un crit 20!');
    }
